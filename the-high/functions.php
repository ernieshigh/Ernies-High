...
function high_scripts() {
	...
	if ( is_page_template( array( 'template-yoga.php'))){                                                                            
...
function defer_parsing_of_js( $url ) {
    ...
    if ( strpos( $url, 'scroll-js' ) ) return $url;
...
function high_read_more( $more ) {
    ...
    return '...<a class="read-more" href="'.get_the_permalink().'" rel="nofollow"> read more about ' . $post->post_title . '<span class="icons">arrow_forward</span></a>';
}
