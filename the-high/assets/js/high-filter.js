...
jQuery(document).ready(function ($) {
  ...
  $(".remove-filters").on("click", function (e) {
    ...
    $("body")
      .find(".filter-col.right-col .filter-content")
      .html(
        '<div class="filter-text bob"><p class="filter-notice">PLEASE NOTE: Each time you click on an option, the list will be updated with a group of products that match your criteria.</p></div>'
      );
    $("body").find(".filter-col.right-col .filter-wrap").remove();

    $("body")
      .find(".filter-col.left-col .cat-menu ul")
      .removeClass("active selected")
      .removeAttr("disabled");
    $("body")
      .find(".filter-col.left-col .cat-menu ul.download-cat")
      .removeClass("inactive")
      .removeAttr("disable");
    $("body")
      .find(".filter-col.left-col li.download-items")
      .removeClass("nada");
    $(".filter-col.left-col li.download-items input.sub-cats").removeAttr(
      "checked"
    );
    $(".filter-col.left-col li.download-items input.sub-cats").removeAttr(
      "disabled"
  ...
  $(document.body).on(
    ...
    function (event) {
      ...
      console.log(
        "This is a parent " + pcat + "this is all the ps " + parent.toString()
      );
      // get filter posts
